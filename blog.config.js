...
const BLOG = {
  ...
  // Note: THEME_SWITCH moved to conf/widget.config.js
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Parker Chen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A developer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.parkerchenca.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog, Next.js', // 网站关键词 英文逗号隔开
  ...
  // Note: NOTION_HOST moved to conf/image.config.js
